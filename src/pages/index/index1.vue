...
<template>
  <view class="t-login">
    ...
    <!-- 标题 -->
    <view class="t-b center">{{ title }}</view>
    <view class="t-b2 center">欢迎使用</view>
    <form class="cl">
      <view class="t-a">
...
export default {
  data() {
    return {
      title: '胡承龙', // 填写logo或者app名称，也可以用：欢迎回来，看您需求
      second: 60, // 默认60秒
  ...
  methods: {
    ...
    login() {
      ...
      if (!/^1[3,45789][0-9]{9}$/.test(that.phone)) {
